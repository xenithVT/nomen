...
func _unhandled_input(event: InputEvent) -> void:
	...
	interact_target != null and
	!Gamestate.in_dialogue and
	!interact_target.is_in_group("scene_transition")):
		interact_target.interact()
	else:
		#print_debug("interaction failed")
		pass
	if event.is_action_pressed("player_cancel") and Gamestate.in_dialogue:
		pass
